...
// Omit -> Omite/esconde determinadas propriedades da interface
// Pick -> Importa algumas propriedades de uma interface
...
// VS Code completa as propriedades de ambos objetos
localUser.name = 'Lukas'
localRepository.name = 'typescript'